            ...
            <div className="container-colom2">
              <div className="berkas-terbit">
                ...
                <div className="mtp-25 mlf-28">
                  ...
                  <span className="bg-blue inter-30 br-10 mtp-10 pd-5 fw-500">
                    Rp. 5.210.596.075
                  </span>{" "}
                  <br />
                  {data && (
              ...
              <div className="card-dputr">
                <div className="container-colom">
                  <div className="clm-12 ts-center">
                    ...
                    <div className="card-rupiah mlf-35 mtp-15">Rp. 5.210.596<br/>075</div>
              ...
              <div className="proses-penerbitan">
                <div className="container-colom">
                  ...
                  <div>
                    ...
                    <div className="card-rupiah mtp-35">Rp. 5.210.596<br/>075</div>
